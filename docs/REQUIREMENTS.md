...
- [ ] Докуентация по конфигурации и формату MLG для пользователей
- [ ] Улучшение debug-интерфейса: команды для статуса, стрима состояния, чтения конфига, получения списка файлов и логов через USB
